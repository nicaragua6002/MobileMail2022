...
namespace MobileMail.Controllers
{
    public class MailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,From,To,Content,Date,Status")] Mail mail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,From,To,Content,Date,Status")] Mail mail)
        {
            if (ModelState.IsValid)
            {
